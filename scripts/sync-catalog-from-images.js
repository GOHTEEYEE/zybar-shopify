...
function productPageTemplate(slug, name, imagePath, price30) {
  ...
  return [
    ...
    '        <p class="pdp-custom-subtitle">Order your one-of-one LED artwork in under a minute.</p>',
    '        <div class="pdp-custom-steps">',
    '          <div class="pdp-custom-step"><span class="pdp-custom-step-num">01</span><span class="pdp-custom-step-icon">🖼</span><span class="pdp-custom-step-title">Upload Your Car</span></div>',
    '          <div class="pdp-custom-step"><span class="pdp-custom-step-num">02</span><span class="pdp-custom-step-icon">🚗</span><span class="pdp-custom-step-title">Enter Your Car Model</span></div>',
    '          <div class="pdp-custom-step"><span class="pdp-custom-step-num">03</span><span class="pdp-custom-step-icon">💡</span><span class="pdp-custom-step-title">Choose Your Lighting Style</span></div>',
    '          <div class="pdp-custom-step"><span class="pdp-custom-step-num">04</span><span class="pdp-custom-step-icon">✨</span><span class="pdp-custom-step-title">We Handcraft It</span></div>',
    '          <div class="pdp-custom-step"><span class="pdp-custom-step-num">05</span><span class="pdp-custom-step-icon">🌍</span><span class="pdp-custom-step-title">Delivered Worldwide</span></div>',
    '        </div>',
    '      </section>',
    '    </main>',
    '',

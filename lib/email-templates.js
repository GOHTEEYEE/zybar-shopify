 ...
 *
 * Welcome / Cart / Purchase journeys live in dedicated modules.
 */
const C = require('./email-components.js');
const WelcomeJourney = require('./welcome-journey.js');
const CartJourney = require('./cart-journey.js');
const PurchaseJourney = require('./purchase-journey.js');
const LunevaWelcomeJourney = require('./luneva-welcome-journey.js');
const LunevaCartJourney = require('./luneva-cart-journey.js');
const LunevaPurchaseJourney = require('./luneva-purchase-journey.js');

const DEFAULT_STORE_NAME = 'ZYBAR';
const DEFAULT_STORE_URL = 'https://www.zybar.shop';
const DEFAULT_DISCOUNT_CODE = 'ZYBAR15';
const LUNEVA_STORE_NAME = 'LUNEVA';
const LUNEVA_DISCOUNT_CODE = 'LUNEVA5';
...
function renderCartDayEmail(day, vars) {
  vars = vars || {};
  const rendered = CartJourney.renderCartDay(day, {
    storeName: vars.storeName || DEFAULT_STORE_NAME,
    storeUrl: vars.storeUrl || DEFAULT_STORE_URL,
    discountCode: vars.discountCode || DEFAULT_DISCOUNT_CODE,
    customerName: vars.customerName || null
...
function renderLunevaWelcomeDayEmail(day, vars) {
  vars = vars || {};
  const rendered = LunevaWelcomeJourney.renderWelcomeDay(day, {
    storeName: vars.storeName || LUNEVA_STORE_NAME,
    storeUrl: vars.storeUrl || DEFAULT_STORE_URL,
    discountCode: vars.discountCode || LUNEVA_DISCOUNT_CODE,
    customerName: vars.customerName || null
  });
  return {
    subject: vars.subject || rendered.subject,
...
function renderLunevaCartDayEmail(day, vars) {
  vars = vars || {};
  const rendered = LunevaCartJourney.renderCartDay(day, {
    storeName: vars.storeName || LUNEVA_STORE_NAME,
    storeUrl: vars.storeUrl || DEFAULT_STORE_URL,
    discountCode: vars.discountCode || LUNEVA_DISCOUNT_CODE,
    customerName: vars.customerName || null
...
function renderLunevaPurchaseDayEmail(day, vars) {
  vars = vars || {};
  const rendered = LunevaPurchaseJourney.renderPurchaseDay(day, {
    storeName: vars.storeName || LUNEVA_STORE_NAME,
    storeUrl: vars.storeUrl || DEFAULT_STORE_URL,
    discountCode: vars.discountCode || LUNEVA_DISCOUNT_CODE,
    customerName: vars.customerName || null
...
function renderPurchaseDayEmail(day, vars) {
  vars = vars || {};
  const rendered = PurchaseJourney.renderPurchaseDay(day, {
    storeName: vars.storeName || DEFAULT_STORE_NAME,
    storeUrl: vars.storeUrl || DEFAULT_STORE_URL,
    discountCode: vars.discountCode || DEFAULT_DISCOUNT_CODE,
    customerName: vars.customerName || null
...
const TEMPLATE_CATALOG = [
  ...
  },
  {
    ...
    journeys: ['welcome_journey', 'cart_journey', 'win_back_journey'],
    components: [
      'header',
      'rich_text',
      'coupon',
  ...
  },
  {
    key: 'cart_day0',
    name: 'Cart Day 0',
    description: 'Soft cart reminder — piece still waiting.',
    journeys: ['cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'cart_day1',
    name: 'Cart Day 1',
    description: 'Imagine it on your wall — atmosphere.',
    journeys: ['cart_journey'],
    components: ['header', 'rich_text', 'image_block', 'button', 'footer']
  },
  {
    key: 'cart_day2',
    name: 'Cart Day 2',
    description: 'Need a hand — sizing, shipping, support.',
    journeys: ['cart_journey'],
    components: ['header', 'rich_text', 'soft_panel', 'button', 'text_link', 'footer']
  },
  {
    key: 'cart_day3',
    name: 'Cart Day 3',
    description: 'Collector social proof.',
    journeys: ['cart_journey'],
    components: ['header', 'rich_text', 'quote_with_image', 'button', 'footer']
  },
  {
    key: 'cart_day4',
    name: 'Cart Day 4',
    description: 'Craft and selective illumination value.',
    journeys: ['cart_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'cart_day5',
    name: 'Cart Day 5',
    description: 'Member savings still apply.',
    journeys: ['cart_journey'],
  ...
  },
  {
    key: 'cart_day6',
    name: 'Cart Day 6',
    description: 'Make it yours — cart or custom.',
    journeys: ['cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'text_link', 'footer']
  },
  {
    key: 'cart_day7',
    name: 'Cart Day 7',
    description: 'Quiet final cart invitation.',
    journeys: ['cart_journey'],
    components: ['header', 'hero', 'rich_text', 'coupon', 'button', 'feature_icons', 'footer']
  },
  {
    key: 'luneva_welcome_day0',
    name: 'LUNEVA Welcome Day 0',
    description: 'Welcome to LUNEVA — gift of light and 15% welcome.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'hero', 'rich_text', 'coupon', 'button', 'feature_icons', 'footer']
  },
  {
    key: 'luneva_welcome_day1',
    name: 'LUNEVA Welcome Day 1',
    description: 'Beauty in motion — mechanical butterfly atmosphere.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'rich_text', 'image_block', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day2',
    name: 'LUNEVA Welcome Day 2',
    description: 'Made for gifting — occasions and romance.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day3',
    name: 'LUNEVA Welcome Day 3',
    description: 'Meet the four-kit collection.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'rich_text', 'collection_card', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day4',
    name: 'LUNEVA Welcome Day 4',
    description: 'What makers say — reviews.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'rich_text', 'quote_with_image', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day5',
    name: 'LUNEVA Welcome Day 5',
    description: 'Assemble in an evening — DIY craft.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day6',
    name: 'LUNEVA Welcome Day 6',
    description: 'Why LUNEVA — craft vs generic LED décor.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'rich_text', 'image_block', 'feature_icons', 'button', 'footer']
  },
  {
    key: 'luneva_welcome_day7',
    name: 'LUNEVA Welcome Day 7',
    description: 'Final welcome invitation with 15%.',
    journeys: ['luneva_welcome_journey'],
    components: ['header', 'hero', 'rich_text', 'coupon', 'button', 'text_link', 'footer']
  },
  {
    key: 'luneva_cart_day0',
    name: 'LUNEVA Cart Day 0',
    description: 'Soft LUNEVA cart reminder.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'luneva_cart_day1',
    name: 'LUNEVA Cart Day 1',
    description: 'Picture the glow.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'rich_text', 'image_block', 'button', 'footer']
  },
  {
    key: 'luneva_cart_day2',
    name: 'LUNEVA Cart Day 2',
    description: 'Need a hand — shipping and FAQs.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'rich_text', 'button', 'text_link', 'footer']
  },
  {
    key: 'luneva_cart_day3',
    name: 'LUNEVA Cart Day 3',
    description: 'Gift stories / social proof.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'rich_text', 'quote_with_image', 'button', 'footer']
  },
  {
    key: 'luneva_cart_day4',
    name: 'LUNEVA Cart Day 4',
    description: 'Why the craft matters.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'luneva_cart_day5',
    name: 'LUNEVA Cart Day 5',
    description: '15% savings still apply.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'rich_text', 'coupon', 'button', 'footer']
  },
  {
    key: 'luneva_cart_day6',
    name: 'LUNEVA Cart Day 6',
    description: 'Finish your gift.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'text_link', 'footer']
  },
  {
    key: 'luneva_cart_day7',
    name: 'LUNEVA Cart Day 7',
    description: 'Quiet final LUNEVA cart invitation.',
    journeys: ['luneva_cart_journey'],
    components: ['header', 'hero', 'rich_text', 'coupon', 'button', 'feature_icons', 'footer']
  },
  {
    key: 'luneva_purchase_day0',
    name: 'LUNEVA Purchase Day 0',
    description: 'Thank you after LUNEVA purchase.',
    journeys: ['luneva_customer_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'luneva_purchase_day1',
    name: 'LUNEVA Purchase Day 1',
    description: 'Review invite after LUNEVA purchase.',
    journeys: ['luneva_customer_journey'],
    components: ['header', 'rich_text', 'image_block', 'button', 'footer']
  },
  {
    key: 'cart_reminder',
    name: 'Cart Reminder',
    description: 'Legacy alias for Cart Day 0.',
    journeys: ['cart_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'need_help',
    name: 'Need Help',
    description: 'Legacy alias for Cart Day 2 support email.',
    journeys: ['cart_journey', 'win_back_journey'],
    components: ['header', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'purchase_day0',
    name: 'Purchase Day 0',
  ...
  },
  {
    key: 'purchase_day1',
    name: 'Purchase Day 1',
    description: 'Piece being prepared — anticipation.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'purchase_day2',
    name: 'Purchase Day 2',
    description: 'How to live with light — lifestyle.',
    journeys: ['customer_journey'],
    components: ['header', 'rich_text', 'image_block', 'button', 'footer']
  },
  {
    key: 'purchase_day3',
    name: 'Purchase Day 3',
    description: 'Install with ease — setup guidance.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'footer']
  },
  {
    key: 'purchase_day4',
    name: 'Purchase Day 4',
    description: 'Share your setup — community.',
    journeys: ['customer_journey'],
    components: ['header', 'image_block', 'rich_text', 'button', 'footer']
  },
  {
    key: 'purchase_day5',
    name: 'Purchase Day 5',
    description: 'Leave a collector review.',
    journeys: ['customer_journey'],
    components: ['header', 'rich_text', 'review', 'button', 'footer']
  },
  {
    key: 'purchase_day6',
    name: 'Purchase Day 6',
    description: 'Your next chapter — companion piece / custom.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'text_link', 'footer']
  },
  {
    key: 'purchase_day7',
    name: 'Purchase Day 7',
    description: 'Welcome to the garage — belonging close.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'soft_panel', 'button', 'feature_icons', 'footer']
  },
  {
    key: 'thank_you',
    name: 'Thank You',
    description: 'Legacy alias for Purchase Day 0.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
    key: 'review_request',
    name: 'Review Request',
    description: 'Legacy alias for Purchase Day 5.',
    journeys: ['customer_journey'],
    components: ['header', 'rich_text', 'review', 'button', 'footer']
  },
  {
    key: 'new_collection',
    name: 'New Collection',
    description: 'Legacy alias for Purchase Day 6 next-chapter tone.',
    journeys: ['customer_journey'],
    components: ['header', 'hero', 'rich_text', 'button', 'footer']
  },
  {
...
function renderTemplate(templateKey, vars) {
  ...
  switch (key) {
    ...
    case 'cart_reminder':
    case 'cart_day0':
      return renderCartDayEmail(0, vars);
    case 'cart_day1':
      return renderCartDayEmail(1, vars);
    case 'cart_day2':
    case 'need_help':
      return renderCartDayEmail(2, vars);
    case 'cart_day3':
      return renderCartDayEmail(3, vars);
    case 'cart_day4':
      return renderCartDayEmail(4, vars);
    case 'cart_day5':
      return renderCartDayEmail(5, vars);
    case 'cart_day6':
      return renderCartDayEmail(6, vars);
    case 'cart_day7':
      return renderCartDayEmail(7, vars);
    case 'luneva_welcome_day0':
      return renderLunevaWelcomeDayEmail(0, vars);
    case 'luneva_welcome_day1':
      return renderLunevaWelcomeDayEmail(1, vars);
    case 'luneva_welcome_day2':
      return renderLunevaWelcomeDayEmail(2, vars);
    case 'luneva_welcome_day3':
      return renderLunevaWelcomeDayEmail(3, vars);
    case 'luneva_welcome_day4':
      return renderLunevaWelcomeDayEmail(4, vars);
    case 'luneva_welcome_day5':
      return renderLunevaWelcomeDayEmail(5, vars);
    case 'luneva_welcome_day6':
      return renderLunevaWelcomeDayEmail(6, vars);
    case 'luneva_welcome_day7':
      return renderLunevaWelcomeDayEmail(7, vars);
    case 'luneva_cart_day0':
      return renderLunevaCartDayEmail(0, vars);
    case 'luneva_cart_day1':
      return renderLunevaCartDayEmail(1, vars);
    case 'luneva_cart_day2':
      return renderLunevaCartDayEmail(2, vars);
    case 'luneva_cart_day3':
      return renderLunevaCartDayEmail(3, vars);
    case 'luneva_cart_day4':
      return renderLunevaCartDayEmail(4, vars);
    case 'luneva_cart_day5':
      return renderLunevaCartDayEmail(5, vars);
    case 'luneva_cart_day6':
      return renderLunevaCartDayEmail(6, vars);
    case 'luneva_cart_day7':
      return renderLunevaCartDayEmail(7, vars);
    case 'luneva_purchase_day0':
      return renderLunevaPurchaseDayEmail(0, vars);
    case 'luneva_purchase_day1':
      return renderLunevaPurchaseDayEmail(1, vars);
    case 'thank_you':
    case 'purchase_day0':
      return renderPurchaseDayEmail(0, vars);
    case 'purchase_day1':
      return renderPurchaseDayEmail(1, vars);
    case 'purchase_day2':
      return renderPurchaseDayEmail(2, vars);
    case 'purchase_day3':
      return renderPurchaseDayEmail(3, vars);
    case 'purchase_day4':
      return renderPurchaseDayEmail(4, vars);
    case 'review_request':
    case 'purchase_day5':
      return renderPurchaseDayEmail(5, vars);
    case 'new_collection':
    case 'purchase_day6':
      return renderPurchaseDayEmail(6, vars);
    case 'purchase_day7':
      return renderPurchaseDayEmail(7, vars);
    case 'browsing_nudge':
...
module.exports = {
  ...
  renderCartDayEmail,
  renderLunevaWelcomeDayEmail,
  renderLunevaCartDayEmail,
  renderLunevaPurchaseDayEmail,
  renderPurchaseDayEmail,
  WelcomeJourney,
  CartJourney,
  PurchaseJourney,
  LunevaWelcomeJourney,
  LunevaCartJourney,
  LunevaPurchaseJourney,

 ...
 * @param {{ to: string|string[], subject: string, html: string, headers?: Record<string, string>, env?: NodeJS.ProcessEnv|Record<string, string|undefined> }} options
 */
async function sendEmail({ to, subject, html, headers, env }) {

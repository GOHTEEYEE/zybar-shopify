...
function buildSystemPrompt(options) {
  ...
  return [
    ...
    '- Typical delivery window overall: about 7–21 business days depending on method and destination',
    '- Standard sizes: 30 x 45 cm and 40 x 60 cm',
    '- Power: Universal USB (cable included; customer uses any USB power block) and optional USB + battery upgrade',
    '- Features: remote control, multiple lighting modes, memory function, premium acrylic, matte backing, easy wall mount, no drilling required',
    '- Returns: 30-day easy returns (damaged items: contact within 48 hours with photos)',
    '- Payments: major cards (Visa, Mastercard, AMEX), Apple Pay / Google Pay where available, PayPal where offered',
    '- Customization: customers can send a photo via contact form to discuss custom art',
    ...
    '',
    'FAQ highlights:',
    '- Shipping is calculated at checkout; customers choose Standard or Priority.',
    '- USB works worldwide without a regional wall adapter (cable only).',
